...
- **Rolle**: Repraesentiert eine fachliche Berechtigungskategorie mit Name, erlaubten Bereichen und erlaubten Aktionen.
- **Nutzer:in**: Repraesentiert eine Person im System mit genau einer aktuell wirksamen Rollenzuweisung.
- **Rollenzuweisung**: Repraesentiert die Zuordnung einer Rolle zu einer Person inklusive aktuellem Status der Zuweisung.
- **Geschuetzter Bereich**: Repraesentiert einen Systembereich oder eine Funktion, fuer die der Zugriff anhand der zugewiesenen Rolle erlaubt oder verweigert wird.
